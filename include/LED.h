...
public:
  ...
  LEDFixture(int addr, int ch, std::string nm, int id, uint8_t mast=255) : BaseFixture(addr, ch, nm, id,  mast){};
  void init() override;
...
public:
  ...
  void new_frame() override; // computes the new frame's RGB values
};
