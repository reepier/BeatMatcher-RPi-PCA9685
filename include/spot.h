...
#     # ###    #     # #    # #    # #    # #      #   #  
 ...
 class SpotRackAnimation6 : public SpotRackAnimation{
  public:
    // Animation parameters (constant or set by animation constructor)
    simpleColor back_color;
    color_vec flash_colors;
    ...
    // Constructor
    SpotRackAnimation6(SpotRack *f,  time_t flen, time_t finterv, std::string d, std::string i, AnimationType t, int prio, int mast, int_vec intens)
    :SpotRackAnimation(d, i, t, mast, prio, intens){
      this->fixture = f;
      this->autocolor = true;
