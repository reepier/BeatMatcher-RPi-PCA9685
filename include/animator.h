...
class AnimationManager{
    ...
    int flash_color[3];     
    int color2[6];          // {0 Rmin, 1 Rmax, 2 Gmin, 3 Gmax, 4 Bmin, 5 Bmax}
    int backgd_color[3];
    bool flash = true;

    // float coef = 0;
    unsigned long period[6];    // // random frequencis (periods) for color sine wave: {0 Rf1, 1 Rf2, 2 Gf1, 3 Gf2, 4 Bf1, 5 Bf2}
