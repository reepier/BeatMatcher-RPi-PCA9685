...
// -- CONFIG ------------------------------------------------------------
#define FRATE   60          //Hz program main frame rate
...
// Music sampler
    ...
    #define FREQ_BAND 4          // frequency band used to evaluate volume (low value for bass / high value for treble) //TODO calibrate
...
#define     SPOTRACK_ANI1_BkG_INTENSITY_LOW   50
...
#define     DANCEFL_TEMPO_ANI       5000      // average animation duration in the dancefloor
