...
void LEDAnimation1::new_frame(){
    ...
    backgd_color[R] = (backgd_RGB_minmax[0]+backgd_RGB_minmax[1])/2 
                        + (backgd_RGB_minmax[1]-backgd_RGB_minmax[0])/4 * (sin(2*3.14*t_ms/periods_ms[0])+sin(2*3.14*t_ms/periods_ms[1]));
    backgd_color[G] = (backgd_RGB_minmax[2]+backgd_RGB_minmax[3])/2 
                        + (backgd_RGB_minmax[3]-backgd_RGB_minmax[2])/4 * (sin(2*3.14*t_ms/periods_ms[2])-sin(2*3.14*t_ms/periods_ms[3]));
    backgd_color[B] = (backgd_RGB_minmax[4]+backgd_RGB_minmax[5])/2 
                        + (backgd_RGB_minmax[5]-backgd_RGB_minmax[4])/4 * (sin(2*3.14*t_ms/periods_ms[4])-sin(2*3.14*t_ms/periods_ms[5]));
