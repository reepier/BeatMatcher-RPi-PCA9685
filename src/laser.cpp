...
void LaserFixture::init(){
    ...
    this->animations.push_back(new LaserAnimation1(this, 11, color_vec{white, yellow},    "Circle Dance white, yellow",   "LAS.1.2.4", any));
    this->animations.push_back(new LaserAnimation1(this, 12, color_vec{white, cyan},      "Circle Dance white, cyan",     "LAS.1.2.5", any));
    this->animations.push_back(new LaserAnimation1(this, 13, color_vec{white, magenta},   "Circle Dance white, magenta",  "LAS.1.2.6", any));
    ...
    this->animations.push_back(new LaserAnimation1(this, 116,    color_vec{white},   "Glitter white",    "LAS.4.1.7", any));
    // Glitter Bichrom4
    this->animations.push_back(new LaserAnimation1(this, 117,    color_vec{red, white},     "Glitter red white",     "LAS.4.2.1", any));
    this->animations.push_back(new LaserAnimation1(this, 118,    color_vec{green, white},   "Glitter green white",   "LAS.4.2.2", any));
    this->animations.push_back(new LaserAnimation1(this, 119,    color_vec{blue, white},    "Glitter blue white",    "LAS.4.2.3", any));
    this->animations.push_back(new LaserAnimation1(this, 120,    color_vec{yellow, white},  "Glitter yellow white",  "LAS.4.2.4", any));
    this->animations.push_back(new LaserAnimation1(this, 121,    color_vec{cyan, white},    "Glitter cyan white",    "LAS.4.2.5", any));
    this->animations.push_back(new LaserAnimation1(this, 122,    color_vec{magenta, white}, "Glitter magenta white", "LAS.4.2.6", any));
    ...
    this->animations.push_back(new LaserAnimation1(this, 146,    color_vec{white},    "SmoothB black & white",    "LAS.5.1.7", any));
    // Smooth Broken
    this->animations.push_back(new LaserAnimation1(this, 147,    color_vec{red, white},      "SmoothB red & white",     "LAS.5.2.1",  any));
    this->animations.push_back(new LaserAnimation1(this, 148,    color_vec{green, white},    "SmoothB green & white",   "LAS.5.2.2",  any));
    this->animations.push_back(new LaserAnimation1(this, 149,    color_vec{blue, white},     "SmoothB blue & white",    "LAS.5.2.3",  any));
