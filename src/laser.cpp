...
void LaserFixture::init(){
    ...
    this->animations.push_back(new LaserAnimation1(this, 7,  color_vec{w_white},     "Circle Dance white",     "LAS.1.1.7", any));
    // Circle dance Bicolor
    this->animations.push_back(new LaserAnimation1(this, 8,  color_vec{w_white, red},       "Circle Dance white, red",      "LAS.1.2.1", any));
    this->animations.push_back(new LaserAnimation1(this, 9,  color_vec{w_white, green},     "Circle Dance white, green",    "LAS.1.2.2", any));
    this->animations.push_back(new LaserAnimation1(this, 10,  color_vec{w_white, blue},     "Circle Dance white, blue",     "LAS.1.2.3", any));
    this->animations.push_back(new LaserAnimation1(this, 11, color_vec{w_white, yellow},    "Circle Dance white, yellow",   "LAS.1.2.4", any));
    this->animations.push_back(new LaserAnimation1(this, 12, color_vec{w_white, cyan},      "Circle Dance white, cyan",     "LAS.1.2.5", any));
    this->animations.push_back(new LaserAnimation1(this, 13, color_vec{w_white, magenta},   "Circle Dance white, magenta",  "LAS.1.2.6", any));
    ...
    this->animations.push_back(new LaserAnimation1(this, 32,    color_vec{w_white},      "Glitch white",      "LAS.2.2.7", any));
    // Glitch Bicolor
    this->animations.push_back(new LaserAnimation1(this, 20,    color_vec{w_white, red},          "Glitch white, red",      "LAS.2.1.1", any));
    this->animations.push_back(new LaserAnimation1(this, 21,    color_vec{w_white, green},        "Glitch white, green",    "LAS.2.1.2", any));
    this->animations.push_back(new LaserAnimation1(this, 22,    color_vec{w_white, blue},         "Glitch white, blue",     "LAS.2.1.3", any));
    this->animations.push_back(new LaserAnimation1(this, 23,    color_vec{w_white, yellow},       "Glitch white, yellow",   "LAS.2.1.4", any));
    this->animations.push_back(new LaserAnimation1(this, 24,    color_vec{w_white, cyan},         "Glitch white, cyan",     "LAS.2.1.5", any));
    this->animations.push_back(new LaserAnimation1(this, 25,    color_vec{w_white, magenta},      "Glitch white, magenta",  "LAS.2.1.6", any));
    ...
    // Palm Dance Bichrome
    this->animations.push_back(new LaserAnimation1(this, 50,    color_vec{w_white, red},     "Palm Dance white red",     "LAS.3.1.1", any));
    this->animations.push_back(new LaserAnimation1(this, 51,    color_vec{w_white, green},   "Palm Dance white green",   "LAS.3.1.2", any));
    this->animations.push_back(new LaserAnimation1(this, 52,    color_vec{w_white, blue},    "Palm Dance white blue",    "LAS.3.1.3", any));
    this->animations.push_back(new LaserAnimation1(this, 53,    color_vec{w_white, yellow},  "Palm Dance white yellow",  "LAS.3.1.4", any));
    this->animations.push_back(new LaserAnimation1(this, 54,    color_vec{w_white, cyan},    "Palm Dance white cyan",    "LAS.3.1.5", any));
    this->animations.push_back(new LaserAnimation1(this, 55,    color_vec{w_white, magenta}, "Palm Dance white magenta", "LAS.3.1.6", any));
    ...
    this->animations.push_back(new LaserAnimation1(this, 62,    color_vec{w_white},   "Palm Dance white",     "LAS.3.2.7", any));
    ...
    this->animations.push_back(new LaserAnimation1(this, 116,    color_vec{w_white},   "Glitter white",    "LAS.4.1.7", any));
    // Glitter Bichrom4
    this->animations.push_back(new LaserAnimation1(this, 117,    color_vec{red, w_white},     "Glitter red white",     "LAS.4.2.1", any));
    this->animations.push_back(new LaserAnimation1(this, 118,    color_vec{green, w_white},   "Glitter green white",   "LAS.4.2.2", any));
    this->animations.push_back(new LaserAnimation1(this, 119,    color_vec{blue, w_white},    "Glitter blue white",    "LAS.4.2.3", any));
    this->animations.push_back(new LaserAnimation1(this, 120,    color_vec{yellow, w_white},  "Glitter yellow white",  "LAS.4.2.4", any));
    this->animations.push_back(new LaserAnimation1(this, 121,    color_vec{cyan, w_white},    "Glitter cyan white",    "LAS.4.2.5", any));
    this->animations.push_back(new LaserAnimation1(this, 122,    color_vec{magenta, w_white}, "Glitter magenta white", "LAS.4.2.6", any));
    ...
    this->animations.push_back(new LaserAnimation1(this, 146,    color_vec{w_white},    "SmoothB black & white",    "LAS.5.1.7", any));
    // Smooth Broken
    this->animations.push_back(new LaserAnimation1(this, 147,    color_vec{red, w_white},      "SmoothB red & white",     "LAS.5.2.1",  any));
    this->animations.push_back(new LaserAnimation1(this, 148,    color_vec{green, w_white},    "SmoothB green & white",   "LAS.5.2.2",  any));
    this->animations.push_back(new LaserAnimation1(this, 149,    color_vec{blue, w_white},     "SmoothB blue & white",    "LAS.5.2.3",  any));
