...
int main(){
  ...
  cpt++;
  // cout << beat_analyzer.volume << endl;
...
// ---------------------------------------------------
  void debug(){
    ...
    cout << "//// MUSIQUE /////" << '\n';
    cout << "Volume : " << string((int)(beat_analyzer.volume/1000.0*50), 'O') << '\n'; //beat_analyzer.volume << endl;
    cout << "Threshold : " << beat_analyzer.beat_thresh << '\n';
    cout << "ratio V/T : " << (float)beat_analyzer.volume/beat_analyzer.beat_thresh << '\n';
    cout << "sample Max/Min : " << beat_analyzer.deb_max << "/" << beat_analyzer.deb_min << '\n';
    cout << "Clip : " << beat_analyzer.clip << '\n';
    cout << "Beat : " << string(beat_analyzer.beat, '!')  << '\n';
    cout << '\n';
    cout << "//// ANIMATOR /////" << '\n';
    cout << "State Machine : ";
   ...
   /*
    for (int i=0; i<SAMP_N; i++){
      ...
      cout << (int)beat_analyzer.signal[i][REAL] << " ";
    }
    cout << endl;
    */
